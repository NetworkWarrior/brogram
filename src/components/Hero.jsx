    ...
    return (
        <>
            ...
            <ol className="benefits-list">
                <li>Follow a simple programm with guaranteed results</li>
                <li>Get fit, healthy, strong and shredded</li>
                <li>Learn more about gym, training and technique</li>
                <li>Become a lifetime gymbro 🫂</li>
            </ol>
            <h3>The Rules</h3>
            <p>To complete this programm, you <b>MUST</b> follow these 3 simple rules;</p>
            <ul className="rules-list">
                ...
                <div className="rule-item">
                    ...
                    <p>
                        ...
                        <abbr title="2 seconds down - 2 seconds pause - 2 seconds up"> 2 - 2 - 2 temp</abbr>
                    </p>
                </div>
                <div className="rule-item">
                    <p><b>Weight*</b></p>
                    <p>
                        Select the maximum weight that allows you to complete the set with good forms!
                    </p>
                </div>
            </ul>
            <small>
                * The first and second set should be at 75% and 85% of  you working weight used for the last two sets.
            </small>
